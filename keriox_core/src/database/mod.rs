...
use crate::{event_message::signed_event_message::{SignedEventMessage, SignedNontransferableReceipt, SignedTransferableReceipt}, prefix::IdentifierPrefix};
...
pub enum QueryParameters<'a> {
	BySn { id: IdentifierPrefix, sn: u64 },
	ByDigest { digest: SelfAddressingIdentifier },
	Range { id: IdentifierPrefix, start: u64, limit: u64},
	All { id: &'a IdentifierPrefix }
}
